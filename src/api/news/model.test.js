...
beforeEach(async () => {
  news = await News.create({ title: 'test', body: 'test', annotation: 'test', author_id: 'test', preview: 'test', background: 'test', type: 'test' });
});
...
describe('view', () => {
  it('returns simple view', () => {
    ...
    expect(view.annotation).toBe(news.annotation);
