...
test('POST /posts 201 (admin)', async () => {
  const { status, body } = await request(app())
    .post(`${apiRoot}`)
    .send({ access_token: adminSession, name: 'test', annotation: 'test', description: 'test', genre: 'test', type: 'test', rating: 'test', status: 'test', date: 'test', author: 'test', cover: 'test', chapters: 'test', pages: 'test', reading: 'test', episodes: 'test' })
